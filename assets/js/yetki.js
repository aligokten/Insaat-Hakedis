...
window.Yetki = (function () {
  ...
  const ROLLER = {
    ...
    'Şantiye Şefi':      { ...hepsi('duzenle'), hakedis: 'duzenle', tedarik: 'goruntule',
                           kullanici: 'yok' },
    'Kontrol Şefi':      { ...hepsi('goruntule'), metraj: 'duzenle', kesif: 'duzenle',
                           kalite: 'onayla', hakedis: 'duzenle', kullanici: 'yok' },
    ...
    'Taşeron':           { ozet: 'goruntule', paftalar: 'goruntule', metraj: 'goruntule',
                           kesif: 'yok', isler: 'goruntule', taseron: 'yok', personel: 'goruntule',
